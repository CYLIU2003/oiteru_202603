...
以下の新機能が追加されました。詳細は [CHANGELOG_2026-01-23.md](CHANGELOG_2026-01-23.md) を参照してください。

- **管理画面UIモダン化**: トグルスイッチによる即時切替、モダンなテーブル・カードデザイン
- **柔軟な取得上限設定**: 1日/1週間/1ヶ月から期間選択可能
- **子機設定リモート管理**: 親機から子機の設定を確認・変更可能（次回heartbeatで同期）
